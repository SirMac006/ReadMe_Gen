...
const questions = [
  ...
  { type: 'input', name: 'features', message: 'List the features of your project:' },
  ...
  { type: 'input', name: 'credits', message: 'Who are the contributors or credits for this project?'},
